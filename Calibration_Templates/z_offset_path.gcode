; ZOffset Calibration Path Template
; Each block uses this spiral path pattern
; Placeholders: {{X_OFFSET}}, {{Y_OFFSET}}, {{Z_OFFSET}}, {{X_START}}, {{Y_START}}
; The path is a spiral from outer to inner, then inner to outer
; Coordinates are relative to the block's starting position
